export const colors = {
	primary: {
		...
		alpha: 'var(--color-primary-alpha, rgba(var(--color-primary, #ae0b05), 0.76))',
	...
	text: {
		heading: 'var(--color-heading, var(--color-base, rgba(var(--color-black, #000000), 0.96)) rgba(var(--color-black, #000000), 0.96))',
